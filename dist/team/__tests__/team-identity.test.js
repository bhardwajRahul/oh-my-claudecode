...
function teamConfig(teamName, displayName, sessionId) {
    return {
        name: teamName,
        task: 'task',
        agent_type: 'executor',
...
async function initNamedTeam(cwd, teamName, displayName, sessionId) {
...
describe('team identity OMX parity adapter', () => {
    ...
    it('accepts OMX env aliases while preserving OMC storage', async () => {
        ...
        try {
            ...
            assert.equal(resolveTeamNameForCurrentContext('alias-demo', workerCwd, {
